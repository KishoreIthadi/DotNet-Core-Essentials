    ...
    */
    public static AddAssemblyReference(referenceDTO) {
        ...
        // Checking if selected dll is already referred. 
            ...
            let relative = path.relative(referenceDTO.SourcePath.substring(0, referenceDTO.SourcePath.lastIndexOf(StringUtility.PathSeperator)).replace(/\\/g, StringUtility.PathBackSlash), referenceDTO.DestinationPath.replace(/\\/g, StringUtility.PathBackSlash));
            // Getting JsonObjects. 
