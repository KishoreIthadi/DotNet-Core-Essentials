...
export class StringUtility {
    ...
    public static NotProject: string = 'DTG: The selected csproj is not a core or standard framework';
    ...
    public static CliVersionError: string = 'DTG: Need Core SDK 2.0.3 or higher';
    public static SelectFW: string = 'Select .Net framework';
    public static InvalidProjectName: string = 'DTG: Invalid project name. Select close to try again';
    public static InvalidSolutionName: string = 'DTG: Invalid solution name. Select close to try again';
    ...
    public static SolutionDoesntExists: string = "DTG: Current workspace folder doesn't have a .sln file";
    ...
    public static SelectPublishPath: string = "DTG: Click 'Browse' to select publishing path";
    ...
    public static BrowseDLLPath: string = "DTG: Click 'Browse' to select .dll file";
